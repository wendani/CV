...
2689 Dupont Street&  \\
Ottawa, ON, K1V 8N2  & M: +1 (613) 790 6788\\
Canada & E: wonda.ni@gmail.com (primary), wenda.ni@viscore.com\\
\end{tabular*}
%\end{minipage}%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%\hspace{0.5ex} %
...
\item
  ...
  \begin{itemize}
    ...
    \resitem{Developed in-depth knowledge of NIC hardware data plane and control plane architecture and of the role each module plays
    ...
    \resitem{Learned in-depth knowledge of Linux kernel architecture, Linux kernel programming, Linux network device driver, and Linux network stack.
    Architected the integration and interface solution of embracing HEDA protocol in the Linux networking system.
    Designed and currently implementing software modules of HEDA protocol in C at the kernel network device driver level.}
    \resitem{Led a team of three at the hardware development phase and a team of two at the software development phase.}
    \resitem{Developed an in-depth understanding of various RDMA technologies---InfiniBand, RoCE, and iWARP---through
...
\item
    ...
    \begin{itemize}
        ...
        \textcolor{Red}{Our work was honored as a runner-up for the 2013 Fabio Neri Best Paper Award.}
...
\item[Networking:] IEEE 802.3, EPON, flow control, LAG, IEEE 802.1, bridge, VLAN, PFC, Q-in-Q, GRE, VXLAN, control plane (ioctl, AXI4-Lite, MDIO, I$^2$C),
...
RCU, process context, work queue, kernel thread and sleep (wait queue), kernel preemption, hrtimer, memory management,
char driver, Network traffic control (TC), Tx \& Rx path below layer 3, new API (NAPI), syscall, sysfs, tracepoint, kprobe, kdump, kbuild
...
\item[Hardware:] NetFPGA-10G, Xilinx, Virtex-5, network interface card (Mellanox, Chelsio, Emulex), switch (Arista), SR-IOV
...
\item
\textbf{Technical program committee member} of OSA Photonic Networks and Devices (Networks) 2013, 2014, 2015, 2016

\item
\textbf{Technical program committee member} of IEEE Global Communications Conference (Globecom), Optical Networks and Systems Symposium 2015, 2016
...
\item
\textbf{Technical program committee member} of IEEE International Conference on Optical Network Design and Modeling (ONDM) 2013, 2014, 2015, 2016, 2017
...
Optical and Grid Computing Symposium 2014, 2015, 2016, 2017
...
\item
\textbf{Reviewer} for IEEE/OSA Journal of Lightwave Technology (4), IEEE/OSA Journal of Optical Communications and Networking (10),
IEEE Transactions on Communications (1), IEEE Communications Letters (1),
Elsevier Computer Networks (3), Elsevier Computer Communications (1), Elsevier Optical Switching and Networking (13),
Springer Photonic Network Communications (7), Springer Telecommunication Systems (1), Wiley International Journal of Communication Systems (1),
IEEE China Communications (1), Chinese Optics Letters (1), Acta Electronica Sinica (2), Journal of Beijing University of Posts and Telecommunications (4),
