...
\item
  ...
  {Senior embedded software designer}{Jan. 2017 - present}
  \begin{itemize}
    \resitem{Topics: video backhaul over GigE Vision standard protocol suite}
  \end{itemize}
...
\item[Operating Systems:] Linux (CentOS, Ubuntu, Fedora, Red Hat), Windows, Mac OS X, FreeRTOS
...
network device driver, ARP, TCP/IP, BGP, UDP, DHCP, SNMP, socket programming, InfiniBand, RoCE, iWARP (RDMAP/DDP/MPA), RDMA, Verbs programming,
1588v2, GigE Vision
...
\item[Tools:] Makefile, gdb, crash, gprof, OProfile, strace, ftrace, SystemTap, Wireshark, autoconf, Jira, JTAG

\item[Hardware:] NetFPGA-10G, Xilinx, Virtex-5, network interface card (Mellanox, Chelsio, Emulex), switch (Arista, Ubiquiti),
PCIe, SR-IOV, DMA, Nios II, ARM926EJ-S
...
\item
\textbf{Technical program committee member} of OSA Photonic Networks and Devices (Networks) 2013, 2014, 2015, 2016, 2017
...
\item
\textbf{Reviewer} for IEEE/OSA Journal of Lightwave Technology (4), IEEE/OSA Journal of Optical Communications and Networking (11),
...
IEEE China Communications (1), De Gruyter Journal of Optical Communications (1), Chinese Optics Letters (1), Acta Electronica Sinica (2),
Journal of Beijing University of Posts and Telecommunications (4),
