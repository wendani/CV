...
\item
  ...
  \resitem{Enabled hosting user ACL tables in system COPP/trap field group to fully exploit hardware resource.}
  ...
  \resiten{Pinpointed the root cause of transcient packet match on all ports at new ACL rule installation, and
  designed methods to inhibit such a match for both ingress and egress ACLs.}
