...
\item[Programming Languages:] C, C++ in C, assembly (Nios II, x86 \& x64 (Intel \& AT\&T syntaxes), MicroBlaze, ARM), inline assembly (gcc), C in C++, Java,
C++ (cast, squential container, associative container, implicit interface), Objective-C, Python, XML, AMPL, MATLAB, script (bash, tcsh), Fortran, Verilog, VHDL, SQL %
...
\item[Tools:] Makefile (expansion (recursive, simple, secondary), {\tt eval}, phony target), gdb, crash, gprof, OProfile, strace, ftrace, SystemTap, Wireshark, autoconf, cygwin, cross toolchain (OpenWrt),
Jira, JTAG, SnmpB
