...
\item
  ...
  \begin{itemize}
    ...
    \resitem{Improved the USRT latency performance by over six times through batch data push and bug fixing.}
...
\item[Networking:] IEEE 802.3, auto-negotiation, EEE, EPON, flow control, LAG, IEEE 802.1, bridge, VLAN, PFC, Q-in-Q, GRE, VXLAN,
control plane (ioctl, AXI4-Lite, Avalon-MM, MDIO, I$^2$C), network device driver, ARP (probe, announcement, gratuitous, proxy, RFC 5227), IPv4, LLA,
TCP, BGP, UDP, DHCP, SNMP, socket programming, InfiniBand, RoCEv1, RoCEv2, iWARP (RDMAP/DDP/MPA), RDMA, Verbs programming, 1588v2, GigE Vision
...
\item[FreeRTOS kernel:] interrupt service routine (ISR), binary semaphore, mutex, queue, event group, task management \& scheduling
...
computer \& microcontroller architecture (Nios II, ARM926EJ-S, Cortex-M3/M4),
PHY (Broadcom AEL2005, Marvell 88X3310, 88E1512), Camera Link interface, sensor (Maxim Integrated LM75), LED
