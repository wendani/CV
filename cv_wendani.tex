...
\item[Programming Languages:] C, C++ in C, assembly (Nios II, x86 \& x64 (Intel \& AT\&T syntaxes), ARM), inline assembly (gcc), C in C++, Java,
C++, Objective-C, Python, XML, AMPL, MATLAB, script (bash, tcsh), Fortran, Verilog, VHDL, SQL %

\item[Operating Systems:] Linux (CentOS, Ubuntu, Fedora, Red Hat), FreeRTOS, Windows, Mac OS X

\item[Networking:] IEEE 802.3, auto-negotiation, EEE, EPON (802.3ah), 10GEPON (802.3av), flow control, LAG, IEEE 802.1, bridge, VLAN, PFC, Q-in-Q, GRE, VXLAN,
control plane (ioctl, AXI4-Lite, Avalon-MM, MDIO, I$^2$C), network device driver, ARP (probe, announcement, gratuitous, proxy, RFC 5227), IPv4, LLA (RFC 3927),
TCP, BGP, UDP, DHCP, SNMP (agent, ASN.1 encoding/decoding), SNTPv4 (RFC 4330), NTPv4 (RFC 5905), NicheStack\textsuperscript{TM} IPv4 (arp, udp, snmpv2c),
socket programming, InfiniBand, RoCEv1, RoCEv2, iWARP (RDMAP/DDP/MPA, RFC 5040, 5041, 5044), RDMA, Verbs programming, 1588v2, GigE Vision
...
\item[Data structures (program):] array, linked list, hash table, queue, stack, tree, binary tree, heap, binary search tree, bitmap

\item[Algorithms:] binary search, recursion, sorting (bubble sort, selection sort, insertion sort, shell sort, quick sort, merge sort, radix sort, heap sort),
divide and conquer, dynamic programming, greedy, Dijkstra's algorithm
...
\item[Tools:] Makefile, gdb, crash, gprof, OProfile, strace, ftrace, SystemTap, Wireshark, autoconf, cygwin, Jira, JTAG

\item[Hardware:] NetFPGA-10G, Xilinx, Virtex-5, network interface card (Mellanox, Chelsio, Emulex),
switch (Arista 7124SX, Ubiquiti EdgeSwitch16, Netgear M4200, GS108PE, GS110TP), PCIe, SR-IOV, DMA,
processor microarchitecture (Pentium, Pentium Pro, II, III, PowerPC 601, 603e, 604, 750, 7400),
computer, microcontroller, and SoC architecture (Nios II, ARM926EJ-S, Cortex-M3/M4),
PHY (Broadcom AEL2005, Marvell 88X3310, 88E1512), Camera Link interface, sensor (Maxim Integrated LM75,
Altera Arria 10 internal temperature sensing diode \& IP core), LED

\item[Version Control:] Git (local and remote), Bitbucket, CVS, GitHub

\item[IDE:] Eclipse, Xcode

\item[Text and Graphs:] Vim, Emacs, \LaTeX, PSTricks, Gnuplot, Origin, SMIv1, SMIv2
...
IEEE/OSA Journal of Optical Communications and Networking (11), IEEE Transactions on Communications (1), IEEE Communications Letters (1),
