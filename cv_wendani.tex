...
\item
  ...
  \resitem{In PFC watchdog hardware detection software restoration scenario, migrate PFC storm action from software-managed ACL to hardware native
  ...
  Covered the overlooked case of in-storm PFC watchdog disable, where original Broadcom SAI causes incorrect hardware state machine transition post operation.}
  ...
  \resitem{\textcolor{Red}{White-box switches hit 10,000 production deployment milestone at the end of November 2023.}}
