...
network device driver, ARP (probe, announcement, gratuitous, proxy, RFC 5227), IPv4, LLA (RFC 3927),
TCP, BGP, UDP, DHCP, SNMP (agent, ASN.1 encoding/decoding, trap, mib), SNTPv4 (RFC 4330), NTPv4 (RFC 5905),
NicheStack\textsuperscript{TM} IPv4 (arp, udp, snmpv2c, sntpv4), socket programming, InfiniBand, RoCEv1, RoCEv2,
iWARP (RDMAP/DDP/MPA, RFC 5040, 5041, 5044), RDMA, Verbs programming, 1588v2, GigE Vision
...
\item[Data structures (program):] array, linked list, queue, priority queue, stack,
hash table, lookup table/map,
tree, binary tree, heap, binary search tree, AVL tree, prefix tree/trie,
bitmap/bit vector, set (bitmap, array, linked list, hash table, binary search tree),
suffix array

\item[Algorithms:] searching (linear/sequential search, binary search), iteration, recursion,
...
\item[Tools:] Makefile, gdb, crash, gprof, OProfile, strace, ftrace, SystemTap, Wireshark, autoconf, cygwin, Jira, JTAG, SnmpB
...
\item[Text and Graphs:] Vim, Emacs, Confluence, \LaTeX, PSTricks, Gnuplot, Origin, SMIv1, SMIv2, JSON
