...
C++ ({\tt explicit}, {\tt cast}, squential container, associative container, implicit interface, virtual function \& default argument), Objective-C, Python, XML, AMPL, MATLAB, script (bash, tcsh), Fortran, Verilog, VHDL, SQL %
...
Jira, JTAG, SnmpB,
LFTP, SFTP, SecureCRT (SSH, SFTP), PuTTY,
CodeFlow

\item[Linux command line:] {\tt fdisk},
{\tt ps},
{\tt mkfs}, {\tt grep}, {\tt find}, {\tt mount}, /etc/fstab,
{\tt wget},
{\tt chown}

\item[Hardware:] NetFPGA-10G, Xilinx, Virtex-5, Altera UDP/IP core, network interface card (Mellanox, Chelsio, Emulex),
switch (Arista 7124SX, 7050QX-32S, Ubiquiti EdgeSwitch16, Netgear M4200, GS108PE, GS110TP), PCIe, SR-IOV, DMA,
...
\item[Version Control:] Git (local and remote), Bitbucket, CVS, TortoiseCVS, SVN, TortoiseSVN, GitHub, Source Depot
