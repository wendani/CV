...
\item
  ...
  \resitem{Broadcom SAI v3.6.7.1 (OCP SAI v1.4.1, Broadcom SDK v6.5.16) running on SONiC 201911 branch image
  ...
  \resitem{Upgraded OCP SAI header to v1.5.1, v1.5.2, and enabled image build against Broadcom SAI v3.6.7.1}
  \resitem{SAI change without support from Broadcom: Suppressed global pause ability advertisement on Trident3 server-facing ports (23 line additions);
  Implemented host interface ICMP and ICMPv6 trap, rate limiting, and stat counter attachment (171 line additions);
  Enabled ingress priority group (PG) packet and dropped packet accounting for generic traffic class (TC) to PG mapping (127 line additions, 12 line deletions).}
  ...
  transition (849 line additions, 594 line deletions).
...
neighbor, route, copp, critical resource management (CRM),
virtual switch (vs)),
%
...
fetch -{}-tags, push -{}-force -{}-delete, show, rebase (-i, commit split), apply, cherry-pick, submodule update -{}-recursive,
bisect, blame -{}-line-porcelain, archive),
