...
\item
  ...
  \resitem{Designed Inband Flow Analyzer (IFA) 2.0 transit functionality on TH4 and TD4, compliant with SAI TAM model and object definition.
  Implemented software from orchagent down to Broadcom SAI and up to utility.}
  ...
  \resitem{Designed and implemented CPU-side receive scheme that inhibits kernel network stack forwarding to avoid duplicate packet forwarding.
