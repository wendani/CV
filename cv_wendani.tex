...
\item
  ...
  Hacked SDK (221 insertions, 21 deletions) to bypass hardware limitation on the number of ACL tables user can create (32 on Trident3)
  ...
  Raise the bar; Find the best solutions by widening one's perspective; Distill ideas down to their fundamental truths;
  Keep learning and growing.
  \textcolor{Red}{Earned Outstanding Team Award (优秀团队奖) as a team member.}}
