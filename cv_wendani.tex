...
\item
  ...
  \resitem{Extended sub port router interface support to link aggregation group (LAG) parent port,
  ...
  \resitem{Proposed host interface ICMP and ICMPv6 trap types in OCP switch abstraction interface (SAI). \url{https://github.com/opencomputeproject/SAI/pull/1044}}
  \resitem{Brought up Lambda OS over Celestica Questone platform. Developed fan control and monitoring script to remedy fand daemon crash.}
  \resitem{Brought up Lambda OS over Quanta IX8E-56X and Ruijie B6510-48VS8CQ platforms; Save the system from kernel panic and oops.}
  ...
  % Customized input and output interface index in sFlow v5 header to align with interface name-index mapping used by SNMP.
  ...
  \url{https://github.com/Azure/sonic-swss/pull/1224}, \url{https://github.com/Azure/sonic-swss/pull/1427},
...
neighbor, route, copp, critical resource management (CRM), sFlow,
virtual switch (vs), ZTP
...
file access, socket programming, generic netlink,
...
{\tt ps},
{\tt mkfs}, {\tt rsync}, {\tt less}, {\tt head} (-n), {\tt tail} (-n), {\tt grep} (-r, -i, -n, -v, -q, -{}-color),
{\tt find} (-type), {\tt xargs}, {\tt ln}, {\tt augtool} (-r, set),
{\tt mount}, {\tt unmount}, /etc/fstab,
{\tt file}, {\tt chmod} (+x), {\tt nm}, {\tt tree} (-L),
...
{\tt pkg-config}, {\tt dpkg}, {\tt dpkg-buildpackage} (-rfakeroot, -b, -us, -uc, -j, -nc), {\tt fakeroot}, {\tt debhelper} (dh\_clean),
{\tt which},
{\tt lsusb},
{\tt virsh},
{\tt diff}, {\tt comm},
...
{\tt fetch} -{}-tags, {\tt push} (-{}-force, -{}-delete, -{}-tags), {\tt show}, {\tt rebase} (-i, -{}-preserve-merges, commit split),
{\tt format-patch}, {\tt apply}, {\tt am}, {\tt cherry-pick}, {\tt submodule update} -{}-recursive,
