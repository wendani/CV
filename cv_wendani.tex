...
\item
  ...
  \url{https://github.com/wendani/SONiC/blob/sub_port_master/doc/sonic-sub-port-intf-hld.md}}
...
{\tt push\_back}, {\tt pop\_back}, {\tt erase}, {\tt clear}), std::reverse, std::remove,
%
{\tt isdigit}, {\tt tolower},
{\tt strtol},
string ({\tt NULL}, rational operators, {\tt length}, {\tt find}, {\tt substr}, {\tt npos}), {\tt getline}, stringstream,
{\tt stoul},
%
...
Java, Objective-C,
%
Python (sequence type ({\tt len}), list ({\tt remove}), tuple,
mapping type, dictionary ({\tt items}),
set type, set ({\tt update}),
%
