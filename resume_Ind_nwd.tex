...
\item[Programming Languages:] C, Java, C++, Objective-C, Python, XML, AMPL, MATLAB, bash script, assembly language, Fortran, Verilog, VHDL, SQL %
...
\item[Linux kernel:] kernel architecture, interrupt context, interrupts and interrupt handlers, softirq, tasklet, kernel synchronization, process context, work queues, kernel threads and sleep (wait queues), kernel preemption, hrtimer, Network traffic control (TC), Tx \& Rx path below layer 3, new API (NAPI)
